...
export const DEFAULT_CMS_CONTENT: CMSContentSchema = {
  ...
  pagesSEO: {
    ...
    aPropos: {
      pageName: 'Kami & Komunitas',
      metaTitle: 'Kami & Komunitas — Catzt OS',
      metaDescription: 'Kenali ekosistem, visi, dan komunitas seller Catzt OS.',
      slug: '/a-propos/',
      ogImage: '/images/Catzt-logo.png',
      canonicalUrl: 'https://catzt.com/a-propos/',
      focusKeyword: 'Komunitas Seller Catzt OS',
      twitterCardType: 'summary_large_image',
      schemaType: 'AboutPage',
    },
    expertises: {
      pageName: 'Solution',
      metaTitle: 'Solution — 4 Ekosistem Modular Catzt OS',
      metaDescription: 'Office as Omni-Channel, Omni-Messenger, ZOM as Team Chat, dan Warehouse Management System.',
      slug: '/expertises/',
      ogImage: '/wp-content/uploads/2025/07/image6.jpg',
      canonicalUrl: 'https://catzt.com/expertises/',
      focusKeyword: 'Solusi Omni-Channel dan WMS',
      twitterCardType: 'summary_large_image',
      schemaType: 'Organization',
    },
    references: {
      pageName: 'Merch & Funding',
      metaTitle: 'Merch & Funding Program — Catzt OS',
      metaDescription: 'Official Catzt OS Merchandise dan program pendanaan Seller Growth Funding.',
      slug: '/references/',
      ogImage: '/wp-content/uploads/2025/11/Intel-omnicom-logo-client.svg',
      canonicalUrl: 'https://catzt.com/references/',
      focusKeyword: 'Merchandise dan Funding Seller',
      twitterCardType: 'summary_large_image',
      schemaType: 'Organization',
    },
    actualites: {
      pageName: 'Artikel',
      metaTitle: 'Artikel & Wawasan — Catzt OS',
      metaDescription: 'Artikel terbaru, tips optimasi toko online, dan perkembangan teknologi operasional ecommerce.',
      slug: '/actualites/',
      ogImage: '/wp-content/uploads/2026/01/51e90374-6d77-45c0-aaa7-782e982df077.png',
      canonicalUrl: 'https://catzt.com/actualites/',
      focusKeyword: 'Artikel Ecommerce',
      twitterCardType: 'summary_large_image',
      schemaType: 'Article',
    },
    nousRejoindre: {
      pageName: 'Karir dan Pengembang',
      metaTitle: 'Karir dan Pengembang — Catzt OS',
      metaDescription: 'Bergabung bersama tim Catzt OS atau eksplorasi dokumentasi dan API developer.',
      slug: '/nous-rejoindre/',
      ogImage: '/images/Catzt-logo.png',
      canonicalUrl: 'https://catzt.com/nous-rejoindre/',
      focusKeyword: 'Karir dan Developer API',
      twitterCardType: 'summary_large_image',
      schemaType: 'Organization',
    },
    contact: {
      pageName: 'Hubungi kami',
      metaTitle: 'Hubungi kami — Catzt OS',
      metaDescription: 'Punya pertanyaan atau ingin konsultasi seputar toko dan gudang Anda? Hubungi tim Catzt OS.',
      slug: '/contact/',
      ogImage: '/images/Catzt-logo.png',
      canonicalUrl: 'https://catzt.com/contact/',
      focusKeyword: 'Hubungi Tim Catzt',
      twitterCardType: 'summary_large_image',
  ...
  expertises: {
    mainTitle: 'Semua Urusan Toko Online & Gudang, Jadi Satu di Sini.',
    items: [
      {
        id: 'exp-1',
        slug: 'office-as-omni-channel',
        title: 'Office as Omni-Channel',
        shortDesc: 'Atur semua toko online kamu dari satu layar. Begitu ada barang laku di satu toko, stok di Shopee, Tokopedia, dan TikTok otomatis berkurang sendiri tanpa repot ubah manual.',
      ...
      },
      {
        ...
        shortDesc: 'Semua chat pembeli dari berbagai marketplace kumpul jadi satu tempat. Admin kamu bisa balas cepat tanpa perlu buka-tutup banyak aplikasi toko.',
      ...
      },
      {
        ...
        shortDesc: 'Tempat ngobrol khusus untuk tim kerja kamu. Koordinasi antara admin toko, finance, dan staf gudang jadi rapi dan gak campur aduk sama chat pribadi.',
      ...
      },
      {
        ...
        shortDesc: 'Bantu orang gudang kerja lebih cepat dan anti salah ambil barang. Scan barcode untuk cek rak barang dan cetak ratusan resi kurir dalam sekali klik.',
